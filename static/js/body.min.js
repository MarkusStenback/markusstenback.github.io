! function(e, t) {
    ...
    var p = function(n) {
        ...
        for (e in h = re.support = {}, r = re.isXML = function(e) {
                ...
                return l !== T && 9 === l.nodeType && l.documentElement ? (i = (T = l).documentElement, y = !r(l), n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", function() {
                    ...
                    if (typeof t.getElementsByClassName !== j && y) return t.getElementsByClassName(e)
        ...
        function me(a, e, t) {
            ...
            return e.first ? function(e, t, n) {
                ...
                if (n) {
                    ...
                    for (; e = e[s];)
                        if (1 === e.nodeType || l) {
                            if ((r = (i = e[N] || (e[N] = {}))[s]) && r[0] === E && r[1] === u) return o[2] = r[2];
    ...
    function R(e, t, n, r) {
        if (C.acceptData(e)) {
            var i, o, a = C.expando,
                ...
                l = s ? C.cache : e,
                u = s ? e[a] : e[a] && a;
            if (u && l[u] && (r || l[u].data) || void 0 !== n || "string" != typeof t) return u || (u = s ? e[a] = f.pop() || C.guid++ : a), l[u] || (l[u] = s ? {} : {
                toJSON: C.noop
        ...
        add: function(e, t, n, r, i) {
            ...
            if (g) {
                for (n.handler && (n = (l = n).handler, i = l.selector), n.guid || (n.guid = C.guid++), (a = g.events) || (a = g.events = {}), (c = g.handle) || ((c = g.handle = function(e) {
                    ...
                    }).elem = e), s = (t = (t || "").match(L) || [""]).length; s--;) p = m = (o = Q.exec(t[s]) || [])[1], h = (o[2] || "").split(".").sort(), p && (u = C.event.special[p] || {}, p = (i ? u.delegateType : u.bindType) || p, u = C.event.special[p] || {}, f = C.extend({
                    type: p,
                    origType: m,
                    data: r,
                    handler: n,
    ...
    C.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if ("string" === (o = typeof n) && (i = Re.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(C.css(e, t)), o = "number"), null != n && n == n && ("number" !== o || C.cssNumber[s] || (n += "px"), v.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, r))))) try {
                    l[t] = n
                } catch (e) {}
            }
        },
        ...
        css: function(e, t) {
            return X(this, function(e, t, n) {
                var r, i, o = {},
                    a = 0;
                if (C.isArray(t)) {
                    for (r = Le(e), i = t.length; a < i; a++) o[t[a]] = C.css(e, t[a], !1, r);
                    return o
                }
    ...
    function ft(o, e, t) {
        var n, a, r = 0,
            ...
            l = function() {
                if (a) return !1;
                for (var e = Ge || lt(), t = Math.max(0, u.startTime + u.duration - e), n = 1 - (t / u.duration || 0), r = 0, i = u.tweens.length; r < i; r++) u.tweens[r].run(n);
    ...
    C.fn.extend({
        ...
        attr: function(e, t, n) {
            var r, i, o = e.nodeType;
            if (e && 3 !== o && 8 !== o && 2 !== o) return typeof e.getAttribute === M ? C.prop(e, t, n) : (1 === o && C.isXMLDoc(e) || (t = t.toLowerCase(), r = C.attrHooks[t] || (C.expr.match.bool.test(t) ? ht : pt)), void 0 === n ? r && "get" in r && null !== (i = r.get(e, t)) ? i : null == (i = C.find.attr(e, t)) ? void 0 : i : null !== n ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : void C.removeAttr(e, t))
        },
    ...
    C.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = C.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Gt, "$1" + r) : !1 !== e.jsonp && (e.url += (Ct.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
...
function() {
    var d, p, h, t, n;
    d = jQuery, p = window, h = document, n = {
        navAnchor: "js-anchor",
        navLink: "js-link",
        ...
        for (l = d(this.element), e = d("." + this.options.navAnchor), s = d("." + this.options.navLink), t = d("." + this.options.navIcon), r = this.options.state, o = l.show().height(), c = l.show().outerHeight(!0), u = [], f = void 0, r && "closed" !== r ? t.show() : (l.show().toggleClass(this.options.navClosed), t.show().addClass(this.options.navClosed)), t.on("click", d.proxy(function(e) {
                e.preventDefault(), l.add(t).toggleClass(this.options.navClosed)
            }, this)), e.on("click", function() {
                var e;
                if (location.pathname.replace(/^\//, "") === this.pathname.replace(/^\//, "") && location.hostname === this.hostname && (e = (e = d(this.hash)).length ? e : d("[name=" + this.hash.slice(1) + "]")).length) return d("html,body").animate({
                    scrollTop: e.offset().top - o
                }, 1e3), !1
            }), f = 0; f < s.length;) i = s[f], n = d(i).attr("href"), u.push(n), f += 1;
